...
namespace DevExpress.Web.Demos {
	public static class NorthwindDemoDataProvider {
		const string NorthwindDataContextKey = "DXNorthwindDemoDataContext";
		...
		public static List<Mvc.Invoice> GetInvoices() {
