...
namespace DevExpress.Web.Demos.Mvc {
	public static class WorldCitiesDataProvider {
		const string WorldCitiesDataContextName = "DXWorldCitiesDataContext";
		public static WorldCitiesContext DB {
			get {
				if(HttpContext.Current.Items[WorldCitiesDataContextName] == null)
					HttpContext.Current.Items[WorldCitiesDataContextName] = new WorldCitiesContext();
				return (WorldCitiesContext)HttpContext.Current.Items[WorldCitiesDataContextName];
			}
		}
		...
		const string SessionName = "DXDemoWorldCustomers";
		public static IList<EditableWorldCustomer> GetEditableCustomers() {			
			IList<EditableWorldCustomer> customersList = HttpContext.Current.Session[SessionName] as IList<EditableWorldCustomer>;
