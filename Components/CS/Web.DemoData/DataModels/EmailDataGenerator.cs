...
namespace DevExpress.Web.Demos {
	public static class EmailDataGenerator {
		...
		static object GenerateSent(NonCryptographicRandom rnd) {
			return DateTime.Now.Date.Subtract(TimeSpan.FromDays(rnd.Next(50)));
		}
		static object GenerateSize(NonCryptographicRandom rnd) {
			return (long)(1000 + rnd.Next(300000));
		}
		static object GenerateHasAttachment(NonCryptographicRandom rnd) {
