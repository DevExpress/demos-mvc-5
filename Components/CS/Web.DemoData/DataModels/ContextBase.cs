...
namespace DevExpress.Web.Demos {
	public partial class ContextBase : DbContext {
		public ContextBase(string connectionString) : base(GetResolvedConnectionString(connectionString)) { }
		static string GetResolvedConnectionString(string connectionString) {
