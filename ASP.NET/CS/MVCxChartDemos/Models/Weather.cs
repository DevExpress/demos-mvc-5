...
namespace DevExpress.Web.Demos.Charts {
    public static class WeatherInLondon {
        ...
        public static IList<DayRangeTemperature> GetTemperatureRangeHistory() {
            List<DayRangeTemperature> temperatureHistory = new List<DayRangeTemperature>();
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 01, 01), 6, 2));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 02, 01), 7, 2));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 03, 01), 10, 3));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 04, 01), 14, 5));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 05, 01), 18, 8));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 06, 01), 21, 11));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 07, 01), 22, 13));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 08, 01), 22, 13));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 09, 01), 19, 11));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 10, 01), 15, 8));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 11, 01), 10, 5));
            temperatureHistory.Add(new DayRangeTemperature(new DateTime(2001, 12, 01), 7, 3));
            return temperatureHistory;
        }
    }
    ...
    public class DayRangeTemperature {
        DateTime date;
        int temperature1;
        int temperature2;

        public DateTime Date { get { return date; } }
        public int Temperature1 { get { return temperature1; } }
        public int Temperature2 { get { return temperature2; } }

        public DayRangeTemperature(DateTime date, int temperature1, int temperature2) {
            this.date = date;
