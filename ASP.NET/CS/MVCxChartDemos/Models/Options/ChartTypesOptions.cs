...
namespace DevExpress.Web.Demos.Charts {
    ...
    public class ChartEmptyPointsOptions : ChartDemoOptions {
        public static string ViewTypesSet1Name = "Point, Step Line and Area";
        public static ViewType[] ViewTypesSet1 = new ViewType[] { ViewType.Point, ViewType.StepLine, ViewType.Area };
        public static string ViewTypesSet2Name = "Line, Bar and Range Bar";
        public static ViewType[] ViewTypesSet2 = new ViewType[] { ViewType.Line, ViewType.Bar, ViewType.RangeBar };
        public static string ViewTypesSet3Name = "Spline, Step Area and Range Area";
        public static ViewType[] ViewTypesSet3 = new ViewType[] { ViewType.Spline, ViewType.StepArea, ViewType.RangeArea };

        int viewTypesIndex = 0;
        bool displayEmptyPoints = true;

        public string ViewTypesName {
            get {
                switch(viewTypesIndex) {
                    case 1:
                        return ViewTypesSet2Name;
                    case 2:
                        return ViewTypesSet3Name;
                    default:
                        return ViewTypesSet1Name;
                }
            }
            set {
                if(value.Equals(ViewTypesSet2Name))
                    viewTypesIndex = 1;
                else if(value.Equals(ViewTypesSet3Name))
                    viewTypesIndex = 2;
                else
                    viewTypesIndex = 0;
            }
        ...
        public ViewType[] ViewTypes {
            get {
                switch(viewTypesIndex) {
                    case 1:
                        return ViewTypesSet2;
                    case 2:
                        return ViewTypesSet3;
                    default:
                        return ViewTypesSet1;
                }
            }
        }
        public bool DisplayEmptyPoints { get { return displayEmptyPoints; } set { displayEmptyPoints = value; } }
    }
