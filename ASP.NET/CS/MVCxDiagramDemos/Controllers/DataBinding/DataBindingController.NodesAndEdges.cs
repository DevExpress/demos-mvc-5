...
namespace DevExpress.Web.Demos.Controllers {
    public partial class DataBindingController : DemoController {
        public ActionResult NodesAndEdges() {
            return DemoView("NodesAndEdges", WorkflowDataProvider.LoadData());
        }

        public ActionResult NodesAndEdgesUpdate(MVCxDiagramNodeUpdateValues<EditableFlowObject, int> nodeUpdateValues, MVCxDiagramEdgeUpdateValues<EditableFlowConnection, int> edgeUpdateValues) {
