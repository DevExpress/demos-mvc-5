...
namespace DevExpress.Web.Demos {
    public static class GridViewCustomBindingHandlers {
        static IQueryable<Email> Model { get { return LargeDatabaseDataProvider.Emails.OrderBy(e => e.ID); } }
    ...
    public static class GridViewCustomOperationDataHelper {
        ...
        public static IQueryable ApplyFilter(this IQueryable query, string filterExpression) {
            ...
            if(CriteriaValidator.IsCriteriaOperatorValid(criteria))
                query = query.AppendWhere(CreateConverter(query.Provider.GetType()), criteria);
            return query;
        }
        ...
        public static IEnumerable<GridViewGroupInfo> GetGroupInfo(this IQueryable query, string fieldName, ColumnSortOrder order) {
            ...
            query = query.MakeGroupBy(CreateConverter(query.Provider.GetType()), new OperandProperty(fieldName));
            query = query.MakeOrderBy(CreateConverter(query.Provider.GetType()), new ServerModeOrderDescriptor(new OperandProperty("Key"), order == ColumnSortOrder.Descending));
        ...
        static List<Expression> GetAggregateExpressions(ICriteriaToExpressionConverter converter, Type elementType, List<GridViewSummaryItemState> summaryItems, ParameterExpression groupParam) {
