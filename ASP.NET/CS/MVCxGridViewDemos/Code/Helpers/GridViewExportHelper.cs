    ...
    public class GridViewExportDemoHelper {
        ...
        static Dictionary<string, GridViewExportMethod> CreateExportFormatsInfo() {
            return new Dictionary<string, GridViewExportMethod> {
                {
                    "CustomExportToXLS",
                    (settings, data) => GridViewExtension.ExportToXls(settings, data, new XlsExportOptions())
                },
                {
                    "CustomExportToXLSX",
                    (settings, data) => GridViewExtension.ExportToXlsx(settings, data, new XlsxExportOptions())
                }
            };
        }
