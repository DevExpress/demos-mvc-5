...
namespace DevExpress.Web.Demos {
    public partial class ToolbarsAndUIController : DemoController {
        ...
        ActionResult ContextMenuCore(HtmlEditorContextMenuItemCollection contextMenuItems) {
            ...
            List<ListEditItem> menuItems = contextMenuItems.ConvertAll<ListEditItem>(i =>
            {
                string text = i.Text;
            ...
            if(!RenderUtils.Browser.IsIE)
                menuItems.RemoveAll(i => (i.Value.ToString() == "cut" || i.Value.ToString() == "copy" || i.Value.ToString() == "paste"));
            ViewData["lbContextMenuItems"] = menuItems;
