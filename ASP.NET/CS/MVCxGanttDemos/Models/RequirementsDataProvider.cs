...
public static class RequirementsDataProvider {
    const string
        RequirementsTasksSessionName = "DX_Requirements_Tasks",
        RequirementsDependenciesSessionName = "DX_Requirements_Dependencies",
        RequirementsResourcesSessionName = "DX_Requirements_Resources",
        RequirementsResourceAssignmentsSessionName = "DX_Requirements_ResourceAssignments";
    ...
    public static List<Task> Tasks {
        get {
            if(Session[RequirementsTasksSessionName] == null)
                Session[RequirementsTasksSessionName] = CreateTasks();
            return (List<Task>)Session[RequirementsTasksSessionName];
        }
    }
    public static List<Dependency> Dependencies {
        get {
            if(Session[RequirementsDependenciesSessionName] == null)
                Session[RequirementsDependenciesSessionName] = CreateDependencies();
            return (List<Dependency>)Session[RequirementsDependenciesSessionName];
        }
    }
    public static List<Resource> Resources {
        get {
            if(Session[RequirementsResourcesSessionName] == null)
                Session[RequirementsResourcesSessionName] = CreateResources();
            return (List<Resource>)Session[RequirementsResourcesSessionName];
        }
    }
    public static List<ResourceAssignment> ResourceAssignments {
        get {
            if(Session[RequirementsResourceAssignmentsSessionName] == null)
                Session[RequirementsResourceAssignmentsSessionName] = CreateResourceAssignments();
            return (List<ResourceAssignment>)Session[RequirementsResourceAssignmentsSessionName];
        }
    }
